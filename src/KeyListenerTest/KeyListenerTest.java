...
class KeyListenerTester extends JFrame implements KeyListener {
    ...
    JLabel label;
    static int nX1 = 300, nY1 = 300, nX2 = 100, nY2 = 100, nScore = 0, nX1Temp = nX1, nX2Temp = nX2, nY1Temp = nY1, nY2Temp = nY2, nLastDirection1 = 1, nLastDirection2 = 1;
...
///the keyTyped code is nessessary for KeyListenerTester to work but nothing is needed inside it
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_M) {
            //System.out.println("Right key pressed");   //debug code
            Shoot shoot = new Shoot(nX1, nY1, nLastDirection2, nX2, nY2); //to move right
            //System.out.println("Object 1 at (" + nX1 + ", " + nY1 + ")");
        }
        ...
        if (e.getKeyCode() == KeyEvent.VK_SPACE) {
            //System.out.println("Right key pressed");   //debug code
            Shoot shoot = new Shoot(nX2, nY2, nLastDirection2, nX2, nY2); //to move right
            //System.out.println("Object 1 at (" + nX1 + ", " + nY1 + ")");
        }
    }
