...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static void main(String[] args) {
        new Minigame("Space Wars: Tug a War");
    }
}
...

//Source Bottom of:http://zetcode.com/tutorials/javaswingtutorial/painting/
class DrawImage extends JPanel {
    Image imgPlayer1;
    public DrawImage() {
        loadImage();
        Dimension dmPlayer1 = new Dimension(imgPlayer1.getWidth(null), imgPlayer1.getHeight(null));
        setPreferredSize(dmPlayer1);
    }
    private void loadImage() {
        imgPlayer1 = new ImageIcon("Player1.png").getImage();
    }
    private void doDrawing(Graphics g) {
        Graphics2D g2D = (Graphics2D) g;
        g2D.drawImage(imgPlayer1, 0, 0, null);
    }
    @Override
